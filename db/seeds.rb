...
Comment.find_or_create_by!(body: "そうは思わない", topic: topic1, user: user18)
...
Comment.find_or_create_by!(body: "たしかに", topic: topic8, user: user18)
Comment.find_or_create_by!(body: "最近はいいライブが多いです", topic: topic14, user: user18)
Comment.find_or_create_by!(body: "おすすめはありますか", topic: topic13, user: user1)
Comment.find_or_create_by!(body: "今行ってるツアーライブです", topic: topic14, user: user18)
...
Comment.find_or_create_by!(body: "やはり1stアルバムがおすすめです", topic: topic14, user: user18)
Comment.find_or_create_by!(body: "3rdアルバムあたりで方向性が変わっています", topic: topic14, user: user18)
...
Comment.find_or_create_by!(body: "3rdアルバムの曲は聴いておいたほうだいいです", topic: topic14, user: user18)
Comment.find_or_create_by!(body: "他にもメジャーな曲もよくやるのでそこもおさえておいたほうがいいです", topic: topic14, user: user18)
Comment.find_or_create_by!(body: "ありがとうございます、きいてみます", topic: topic14, user: user1)
Comment.find_or_create_by!(body: "動画サイトに過去のライブもあるので見ておいたほうがいいです", topic: topic14, user: user18)
Comment.find_or_create_by!(body: "独特のノリがあります", topic: topic14, user: user18)
Comment.find_or_create_by!(body: "ぜひ行ってみてください", topic: topic14, user: user18)
...
user8.follow(user7)
user9.follow(user7)
user10.follow(user17)
user11.follow(user10) 
user12.follow(user18)
user13.follow(user12)
user13.follow(user7)
user18.follow(user12)
user18.follow(user7)
...
user18.favorites.find_or_create_by!(artist: artist7)
user18.favorites.find_or_create_by!(artist: artist9)
user18.favorites.find_or_create_by!(artist: artist5)
user18.favorites.find_or_create_by!(artist: artist8)
user18.favorites.find_or_create_by!(artist: artist11)
user18.favorites.find_or_create_by!(artist: artist10)
...
GroupMembership.find_or_create_by!(group: group9, user: user18)
GroupMembership.find_or_create_by!(group: group10, user: user13)
GroupMembership.find_or_create_by!(group: group10, user: user9)
GroupMembership.find_or_create_by!(group: group11, user: user18)
